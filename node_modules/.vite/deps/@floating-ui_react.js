...
function FloatingDelayGroup(props) {
  ...
  const [state, setState] = React3.useReducer((prev, next) => ({
    ...prev,
    ...next
  }), {
    delay,
...
function NextFloatingDelayGroup(props) {
  ...
  return (0, import_jsx_runtime.jsx)(NextFloatingDelayGroupContext.Provider, {
    value: React3.useMemo(() => ({
      hasProvider: true,
      delayRef,
      initialDelayRef,
...
function useNextDelayGroup(context, options) {
  ...
  const groupContext = React3.useContext(NextFloatingDelayGroupContext);
  const {
    currentIdRef,
    delayRef,
    timeoutMs,
...
function FloatingFocusManager(props) {
  ...
  const blurTimeoutRef = React3.useRef(-1);
...
function useClientPoint(context, props) {
  ...
  const initialRef = React3.useRef(false);
  const cleanupListenerRef = React3.useRef(null);
  const [pointerType, setPointerType] = React3.useState();
  const [reactive, setReactive] = React3.useState([]);
  ...
  const addListener = React3.useCallback(() => {
...
export {
  ...
  arrow3 as arrow,
  autoPlacement3 as autoPlacement,
  autoUpdate,
...
tabbable/dist/index.esm.js:
  ...
  *)
*/
//# sourceMappingURL=@floating-ui_react.js.map
